...
app.post('/apartments', async (req: Request, res: Response) => {
  try {
    ...
    const newApartment: Apartment = {
      ...
      Urokova_sadzba: apartmentData.Urokova_sadzba ?? null,
      Pocet_rokov_uveru: apartmentData.Pocet_rokov_uveru ?? null,
      Banka: apartmentData.Banka || '',
      Datum_zaciatku: apartmentData.Datum_zaciatku || '',
      Mesacna_splatka_EUR: apartmentData.Mesacna_splatka_EUR ?? null,
      ...
      Celkove_mesacne_naklady_EUR: apartmentData.Celkove_mesacne_naklady_EUR ?? null,
      Najom_brutto_EUR: apartmentData.Najom_brutto_EUR ?? null,
      Cashflow_mesacny_EUR: apartmentData.Cashflow_mesacny_EUR ?? null,
      Rocna_hruba_vynosnost: apartmentData.Rocna_hruba_vynosnost ?? null,
